...
## 1. 개요
본 문서는 모바일 쿠폰 백오피스의 전체 기술 구성을 정의한다. 아키텍처는 Python 3.11 + FastAPI 기반 백엔드, MariaDB 11.3 데이터베이스, SNAP Agent 및 COUFUN API 연동을 중심으로 설계된다.
...
| 데이터베이스 | MariaDB 11.3 | Docker 내 또는 카페24 VPS 내 별도 서비스, 연결 포트 3306 |
